  ...
  return (
    ...
    <section className="px-8 py-12 md:py-24">
     ...
     <section id="map" className="px-8 py-16 md:py-24">
      ...
      <section
        id="stay"
                        className="relative flex min-h-[75vh] items-end bg-cover bg-top px-8 pb-12 md:items-center md:pb-0"
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl">
          <div className="max-w-xl">
            ...
            <h2 className="font-serif text-5xl leading-tight text-stone-100">
              <span className="hidden md:inline">You've come this far.<br /></span>You may as well stay.
            </h2>
